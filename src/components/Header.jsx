      ...
      <ul className="flex  py-7 semimd:hidden">
        {navmenu.map((menu, idx) => {
          return (
            ...
            <li key={idx} className="px-2 hover:border-b-4 border-white hover:text-[#e06f6f]">
              <NavLink
                to={menu.link}
                activeclassname="text-green-700"
                className="p-2"
        ...
        <div className="flex  justify-center items-center semimd:hidden ">
          {isLoggedIn ? (
            <button
              className="logOut  text-sm mt-2 py-3  mx-3 w-16 rounded-md bg-slate-850"
            ...
            <button
              className="logIn w-16  mt-2 py-3 mx-3 text-sm rounded-md bg-slate-850"
